...
export const findTweetByLikeContaineUser = (userId) => async (dispatch) => {
  try {
...
export const likeTweet = (tweetId) => async (dispatch) => {
  try {
    const { data } = await api.post(`/api/${tweetId}/like`, tweetData);
...
export const deleteTweet = (tweetId) => async (dispatch) => {
  try {
    const { data } = await api.post(`/api/tweets/${tweetId}`, tweetData);
