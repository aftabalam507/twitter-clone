...
public class TweetController {
	...
	public ResponseEntity<List<TweetDto>> getUserAllTweets(@PathVariable Long userId,@RequestHeader("Authorization") String jwt)
			throws UserException, TweetException {
	...
	public ResponseEntity<List<TweetDto>> findTweetByLikesContaineUser(@PathVariable Long userId,@RequestHeader("Authorization") String jwt)
			throws UserException, TweetException {
